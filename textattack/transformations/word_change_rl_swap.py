...
class WordChangeRLSwap(WordChange):
    ...
    def words2swap(self, processed_text):
        ...
        for pattern in list(wordz):
            word_match = re.search(pattern, processed_text)
    ...
    def change_words(self, processed_text, num_candidates=2):
        text_list, mask_list = self.words2swap(processed_text)
