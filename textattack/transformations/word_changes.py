...
from textattack.transformations import WordSwap, Transformation
import re
...
class WordChange(Transformation):
    ...
    def get_transformations(self, text, num_of_candidates=2):
        word_dict = self.change_words(text, num_of_candidates=2)
